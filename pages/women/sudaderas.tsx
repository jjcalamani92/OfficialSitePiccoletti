...
const HombrePage: NextPage = () => {
	...
	const productsCategory = getProductBySubCategory(products, 'sudaderas');
	return (
		<Layout
			title={'Piccoletti - Sudaderas'}
			pageDescription={'las mejores sudaderas'}
		>
			<HeadingPrimary titleP="sudaderas" />
			{isLoading ? (
				<Spinner />
			) : (
